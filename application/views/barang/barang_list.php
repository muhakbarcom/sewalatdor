...
<div class="col-xs-12">
    <div class="box">
      ...
      <div class="box-body">
		...
		<?php echo anchor(site_url('barang/printdoc'), '<i class="fa fa-print"></i> Print Preview', 'class="btn bg-maroon"'); ?>
		<?php echo anchor(site_url('barang/excel'), '<i class="fa fa-file-excel"></i> Excel', 'class="btn btn-success"'); ?>
		<?php echo anchor(site_url('barang/word'), '<i class="fa fa-file-word"></i> Word', 'class="btn btn-primary"'); ?>
                ...
                var t = $("#mytable").DataTable({
                    ...
                    columns: [
                        ...
                        },
                        {
                            "data": "id_barang",
                            "orderable": false
                        },{"data": "nama_barang"},{"data": "harga_sewa"},{"data": "stok"},
                        {
                            "data" : "action",
                            "orderable": false,
                            "className" : "text-center"

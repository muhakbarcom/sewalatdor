    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">List Sewa</h3>
                ...
                <form id="myform" method="post" onsubmit="return false">
                    ...
                    <div class="row" style="margin-bottom: 10px">
                        ...
                        <div class="col-xs-12 col-md-4 text-right">
                            <?php echo anchor(site_url('sewa/printdoc'), '<i class="fa fa-print"></i> Print Preview', 'class="btn bg-maroon"'); ?>
                            <?php echo anchor(site_url('sewa/excel'), '<i class="fa fa-file-excel"></i> Excel', 'class="btn btn-success"'); ?>
                            <?php echo anchor(site_url('sewa/word'), '<i class="fa fa-file-word"></i> Word', 'class="btn btn-primary"'); ?>
